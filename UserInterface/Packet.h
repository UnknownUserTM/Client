...
enum
{
	...
	// HEADER_GC_QUEST_INTRO_DESC					= 220,
	// HEADER_GC_QUEST_INTRO_REWARD				= 221,
	// HEADER_GC_QUEST_INTRO_OBJECTIVE				= 222,
...
typedef struct SChannelStatus
{
	...
	// HEADER_GC_QUEST_INTRO_REWARD			= 221,
	// HEADER_GC_QUEST_INTRO_OBJECTIVE			= 222,
	// HEADER_GC_QUEST_INTRO_REWARD			= 223,
typedef struct packet_questintro_desc_paket
{
	BYTE byHeader;
	char	title;
	char	desc;
} TPacketGCQuestIntroDesc;

typedef struct packet_questintro_reward_paket
{
	BYTE byHeader;
	char	rewardType;
	int		vnum;
	int		count;
} TPacketGCQuestIntroReward;

typedef struct packet_questintro_objective_paket
{
	BYTE byHeader;
	char	desc;
	int		status;
} TPacketGCQuestIntroObjective;
