...
PyObject * systemSetMultiShopLock(PyObject * poSelf, PyObject * poArgs)
{
	int iOpt;
	if (!PyTuple_GetInteger(poArgs, 0, &iOpt))
		return Py_BuildException();

	CPythonSystem::Instance().SetMultiShopLock(iOpt);
	return Py_BuildNone();
}

PyObject * systemIsMultiShopLock(PyObject * poSelf, PyObject * poArgs)
{
