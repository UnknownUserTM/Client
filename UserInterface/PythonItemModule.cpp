...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "EQUIPMENT_COSTUME_WEAPON",   c_Equipment_WeaponCostume);
#endif
	...
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_COSTUME_WEAPON",   CItemData::ITEM_TYPE_COSTUME_WEAPON);
