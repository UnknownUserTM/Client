...
bool LoadLocaleData(const char* localePath)
{
	...
	snprintf(szItemProto,	sizeof(szItemProto),	"locale/%s/item_proto", CPythonLanguageManager::Instance().Get());
	snprintf(szItemDesc,	sizeof(szItemDesc),	"locale/%s/itemdesc.txt",	CPythonLanguageManager::Instance().Get());	
	snprintf(szMobProto,	sizeof(szMobProto),	"locale/%s/mob_proto",		CPythonLanguageManager::Instance().Get());	
	snprintf(szSkillDescFileName, sizeof(szSkillDescFileName),	"locale/%s/SkillDesc.txt", CPythonLanguageManager::Instance().Get());
	snprintf(szItemList,	sizeof(szItemList) ,	"locale/%s/item_list.txt",	CPythonLanguageManager::Instance().Get());		
	snprintf(szSkillTableFileName, sizeof(szSkillTableFileName),	"locale/%s/SkillTable.txt", CPythonLanguageManager::Instance().Get());	
	snprintf(szInsultList,	sizeof(szInsultList),	"locale/%s/insult.txt", CPythonLanguageManager::Instance().Get());
