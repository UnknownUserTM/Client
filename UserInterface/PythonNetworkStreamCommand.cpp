...
void CPythonNetworkStream::ServerCommand(char * c_szCommand)
{
	...
	else
	{
		...
		if (s_isFirst)
		{
			...
			s_emotionDict["doze"] = CRaceMotionData::NAME_NEW_DOZE;
			s_emotionDict["exercise"] = CRaceMotionData::NAME_NEW_EXERCISE;
			s_emotionDict["pushup"] = CRaceMotionData::NAME_NEW_PUSHUP;
			s_emotionDict["selfie"] = CRaceMotionData::NAME_NEW_SELFIE;
			// s_emotionDict["busy"] = CRaceMotionData::NAME_NEW_BUSY;
			s_emotionDict["dance7"] = CRaceMotionData::NAME_NEW_DANCE_7;
		}
