...
class CPythonChat : public CSingleton<CPythonChat>, public IAbstractChat
{
	public:
		...
		typedef struct SChatLine
		{
			...
			CGraphicTextInstance Instance;
			CGraphicImageInstance InstanceLanguageFlag;
			CGraphicImageInstance InstanceEmpireFlag;
			SChatLine();
			virtual ~SChatLine();
	...
	public:
		...
		// Chat
		void AppendChat(int iType, const char * c_szChat, BYTE bEmpire = 0, const char * szLanguage = "");
