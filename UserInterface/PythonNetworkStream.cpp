...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_SHOUT_FILTER_LIST, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCLoadShoutFilterList), STATIC_SIZE_PACKET));
			Set(HEADER_GC_ITEM_PICKUP,		CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCItemPickup), STATIC_SIZE_PACKET));
			...
			// Set(HEADER_GC_QUEST_INTRO_DESC,			CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCQuestIntroDesc), STATIC_SIZE_PACKET)); // @fixme007
			// Set(HEADER_GC_QUEST_INTRO_REWARD,			CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCQuestIntroReward), STATIC_SIZE_PACKET)); // @fixme007
			// Set(HEADER_GC_QUEST_INTRO_OBJECTIVE,			CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCQuestIntroObjective), STATIC_SIZE_PACKET)); // @fixme007
