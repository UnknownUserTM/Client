...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		// bool QuestIntroDesc();
		// bool QuestIntroReward();
		// bool QuestIntroObjective();
		// Event
	...
	public:
		...
		bool SendShoutLanguageFilterPacket(int bSubHeader, int iType, const char * szText, BYTE * bFilterList);
	...
	protected:
		...
		bool RecvLoadShoutFilterListPacket();
	...
	protected:
		...
		void OnScriptEventStart(int iSkin, int iIndex);//, const string& strScript);
