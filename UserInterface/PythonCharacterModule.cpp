...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "MOTION_NEW_DOZE",					CRaceMotionData::NAME_NEW_DOZE);
	PyModule_AddIntConstant(poModule, "MOTION_NEW_EXERCISE",				CRaceMotionData::NAME_NEW_EXERCISE);
	PyModule_AddIntConstant(poModule, "MOTION_NEW_PUSHUP",					CRaceMotionData::NAME_NEW_PUSHUP);
	PyModule_AddIntConstant(poModule, "MOTION_NEW_SELFIE",					CRaceMotionData::NAME_NEW_SELFIE);
	// PyModule_AddIntConstant(poModule, "MOTION_NEW_BUSY",					CRaceMotionData::NAME_NEW_BUSY);
	PyModule_AddIntConstant(poModule, "MOTION_NEW_DANCE_7",					CRaceMotionData::NAME_NEW_DANCE_7);
