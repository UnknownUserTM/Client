...
std::string g_strEffectName = "d:/ymir work/effect/etc/direction/quest_direction.mse";
// std::string g_strEffectName = "d:/ymir work/effect/etc/empire/quest.mse";
...
bool CPythonBackground::IsInBattlefield()
{
	if ("metin2_map_battlefield" == m_strMapName)
		return true;
